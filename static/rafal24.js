...
// --- procedura wyswietla ostatni pomiar pm25 [ pm25Label - etykieta na index.html ]
function pm25Msq(settings) {
    // Load the latest pm25
    $.getJSON('data/latest/pm25', function(devices) {
      $.each(devices, function(device, data) {
      //Insert the most recent measurements into the #summary div.
        $('#pm25Label').append("PM25 "+data[1]+" µg/m3");
      });
   });
 };
